        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <p class="text-green-500">Utilisateur : {{ $post->user->name }}</p>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        @if ($comment->user)
                            <p class="text-orange-500">Utilisateur : {{ $comment->user->name }}</p>
                        @else
                            <p class="text-orange-500">Pseudo : {{ $comment->pseudo }}</p>
                        @endif
